...
def setup_gif_commands(bot):
    ...
    async def bang(interaction: discord.Interaction, user: discord.Member):
    ...
    async def facepalm(interaction: discord.Interaction, user: discord.Member):
    ...
    async def hide(interaction: discord.Interaction, user: discord.Member):
    ...
    async def jumpscare(interaction: discord.Interaction, user: discord.Member):
