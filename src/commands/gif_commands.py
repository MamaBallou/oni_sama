...
def setup_gif_commands(bot):
    ...
    async def kiss(interaction: discord.Interaction, user: discord.Member = None):
        if user:
    ...
    async def bonk(interaction: discord.Interaction, user: discord.Member = None):
        if user:
    ...
    async def bang(interaction: discord.Interaction, user: discord.Member = None):
        if user:
    ...
    async def facepalm(interaction: discord.Interaction, user: discord.Member = None):
        if user:
    ...
    async def poke(interaction: discord.Interaction, user: discord.Member = None):
        if user:
    ...
    async def patpat(interaction: discord.Interaction, user: discord.Member = None):
        if user:
    ...
    async def hide(interaction: discord.Interaction, user: discord.Member = None):
        if user:
    ...
    async def jumpscare(interaction: discord.Interaction, user: discord.Member = None):
        if user:
    ...
    async def wave(interaction: discord.Interaction, user: discord.Member = None):
        if user:
